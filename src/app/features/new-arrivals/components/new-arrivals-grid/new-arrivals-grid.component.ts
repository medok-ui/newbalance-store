...
@Component({
  ...
  imports: [ProductCatalogCardComponent, FiltersBlockComponent, RouterLink],
  templateUrl: './new-arrivals-grid.component.html',
  styleUrl: './new-arrivals-grid.component.scss',
...
export class NewArrivalsGridComponent {
  ...
  public products = computed(() => {
    const allProducts = this.newArrivalsProducts();
